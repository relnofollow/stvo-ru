          ...
          <div className="row">
            <div className="col col--offset-2 col--8">
              ...
              <div className="alert alert--info margin-bottom--md" role="alert">
                ...
                <br />
                Перевод правил дорожного движения на этом сайте выполнен с
                помощью сервиса <b>машинного перевода</b>, может содержать
                неточности и <b>не является официальным переводом</b> StVO на
                русский язык.
              </div>
              <p>Hallo 👋 Меня зовут Лена, я живу в Берлине 🏙</p>
              <p>
                Цель этого сайта - помочь русскоговорящим людям, живущим в
                Германии, познакомиться с ПДД Германии.
              </p>
              <p>
                Для подготовки к теоретическому эказмену на получение
                водительских прав я использовала приложение, которое повторяет
                вопросы экзамена. И, хотя вопросы и варианты ответов доступны на
                русском языке, в приложении нет перевода полного текста правил.
              </p>
              <p>
