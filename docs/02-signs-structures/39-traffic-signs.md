...
<span id="8">[(8)](#8)</span> В особо опасных ситуациях в качестве предупреждающих знаков в соответствии с [Приложением 1](/docs/appendix-1) могут использоваться также таблички «Погон скота» и «Наездник», а также таблички:
