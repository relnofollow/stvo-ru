...
<table className="signs-table">
    ...
    <tbody>
        <tr>
            <td>1</td>
            <td>Знак 201<img src="/img/signs/sign_201.jpg" /> Андреевский крест</td>
            <td>
        ...
        <tr>
            <td>2</td>
            <td>Знак 205<img src="/img/signs/sign_205.jpg" /> Уступите дорогу.</td>
            <td>
                <span className="subtitle">Требование или запрет</span>
                <dl>
                    <dt>1.</dt>
        ...
        <tr>
            ...
            <td>
                Знак 206
                <img src="/img/signs/sign_206.jpg" />
        ...
        <tr>
            <td>4</td>
            <td>Знак 208<img src="/img/signs/sign_208.jpg" /> Преимущество<br />встречного движения</td>
            <td>
...
<table className="signs-table">
    ...
    <tbody>
        ...
        <tr>
            <td>5</td>
            <td>Знак 209<img src="/img/signs/sign_209.jpg" /> Направо</td>
            <td></td>
        </tr>
        <tr>
            <td>6</td>
            <td>Знак 211<img src="/img/signs/sign_211.jpg" /> Здесь направо</td>
            <td></td>
        </tr>
        <tr>
            <td>7</td>
            <td>Знак 214<img src="/img/signs/sign_214.jpg" /> Прямо или направо</td>
            <td></td>
        </tr>
        <tr>
            <td>8</td>
            <td>Знак 215<img src="/img/signs/sign_215.jpg" /> Круговое движение</td>
            <td>
                <span className="subtitle">Требование или запрет</span>
                <dl>
                    <dt>1.</dt>
        ...
        <tr>
            <td>9</td>
            <td>Знак 220<img src="/img/signs/sign_220.jpg" /> Одностороннее движение</td>
            <td>
...
<table className="signs-table">
    ...
    <tbody>
        <tr>
            <td>10</td>
            <td>Знак 222<img src="/img/signs/sign_222.jpg" /> Объезд справа</td>
            <td>
...
<table className="signs-table">
    ...
    <tbody>
        ...
        <tr>
            <td>11</td>
            <td>Знак 223.1<img src="/img/signs/sign_223.1.jpg" /> Использование обочины</td>
            <td>
        ...
        <tr>
            <td>11.1</td>
            <td><img src="/img/signs/sign_223.2.jpg" /></td>
            <td>
        ...
        <tr>
            <td>12</td>
            <td>Знак 223.2<img src="/img/signs/sign_223.3.jpg" /> Прекращение использования обочины</td>
            <td>
        ...
        <tr>
            <td>13</td>
            <td>Знак 223.3<img src="/img/signs/sign_223.4.jpg" /> Освобождение обочины</td>
            <td>
        ...
        <tr>
            <td>14</td>
            <td>Знак 224<img src="/img/signs/sign_224.jpg" /> Остановка</td>
            <td>
        ...
        <tr>
            <td>15</td>
            <td>Знак 229<img src="/img/signs/sign_229.jpg" /> Стоянка такси</td>
            <td>
        ...
        <tr>
            <td>15.1</td>
            <td>Знак 230<img src="/img/signs/sign_230.jpg" /> Зона погрузки</td>
            <td>
                <span className="subtitle">Требование или запрет</span>
                <dl>
                    <dt>1.</dt>
...
<table className="signs-table">
    ...
    <tbody>
        <tr>
            <td>16</td>
            <td>Знак 237<img src="/img/signs/sign_237.jpg" /> Велосипедная дорожка</td>
            <td>
                <span className="subtitle">Требование или запрет</span>
                <dl>
                    <dt>1.</dt>
        ...
        <tr>
            <td>17</td>
            <td>Знак 238<img src="/img/signs/sign_238.jpg" /> Конная дорожка</td>
            <td>
                <span className="subtitle">Требование или запрет</span>
                <dl>
                    <dt>1.</dt>
        ...
        <tr>
            <td>18</td>
            <td id="239">Знак 239<img src="/img/signs/sign_239.jpg" /> Пешеходная дорожка</td>
            <td>
                <span className="subtitle">Требование или запрет</span>
                <dl>
                    <dt>1.</dt>
        ...
        <tr>
            <td>19</td>
            <td>Знак 240<img src="/img/signs/sign_240.jpg" /> Общая пешеходная и велосипедная дорожка</td>
            <td>
                <span className="subtitle">Требование или запрет</span>
                <dl>
                    <dt>1.</dt>
        ...
        <tr>
            <td>20</td>
            <td>Знак 241<img src="/img/signs/sign_241.jpg" /> Раздельная велосипедная и пешеходная дорожка</td>
            <td>
                <span className="subtitle">Требование или запрет</span>
                <dl>
                    <dt>1.</dt>
        ...
        <tr>
            <td>21</td>
            <td>Знак 242.1<img src="/img/signs/sign_242.1.jpg" /> Начало пешеходной зоны</td>
            <td>
                <span className="subtitle">Требование или запрет</span>
                <dl>
                    <dt>1.</dt>
        ...
        <tr>
            <td>22</td>
            <td>Знак 242.2<img src="/img/signs/sign_242.2.jpg" /> Конец пешеходной зоны</td>
            <td></td>
        </tr>
        <tr>
            <td>23</td>
            <td>Знак 244.1<img src="/img/signs/sign_244.1.jpg" /> Начало велосипедной улицы</td>
            <td>
                <span className="subtitle">Требование или запрет</span>
                <dl>
                    <dt>1.</dt>
        ...
        <tr>
            <td>24</td>
            <td>Знак 244.2<img src="/img/signs/sign_244.2.jpg" /> Конец велосипедной улицы</td>
            <td></td>
        </tr>
        <tr>
            <td>24.1</td>
            <td>Знак 244.3<img src="/img/signs/sign_244.3.jpg" /> Начало велосипедной зоны</td>
            <td>
                <span className="subtitle">Требование или запрет</span>
                <dl>
                    <dt>1.</dt>
        ...
        <tr>
            <td>24.2</td>
            <td>Знак 244.4<img src="/img/signs/sign_244.4.jpg" /> Конец велосипедной зоны</td>
            <td></td>
        </tr>
        <tr>
            <td>25</td>
            <td>Знак 245<img src="/img/signs/sign_245.jpg" /> Полоса для автобусов</td>
            <td>
                <span className="subtitle">Требование или запрет</span>
                <dl>
                    <dt>1.</dt>
...
<table className="signs-table">
    ...
    <tbody>
        <tr>
            ...
            <td>
                <p>
                    <span className="subtitle">Требование или запрет</span><br /> Последующие знаки с <TrafficSign sign="250" /> по <TrafficSign sign="261" /> (запрет движения) полностью или частично запрещают участие в дорожном движении в соответствии с указанным содержанием.
                </p>
                <p>
                    <span className="subtitle">Пояснение</span><br /> Для знаков c <TrafficSign sign="250" /> до <TrafficSign sign="259" /> применяются следующие правила:
                    <dl>
                        <dt>1.</dt>
                        <dd>
        ...
        <tr>
            ...
            <td>
                <span className="subtitle">Требование или запрет</span><br /> Если на дополнительном знаке указана масса, например «7,5 т», запрет действует только в том случае, если разрешенная максимальная масса транспортного средства вместе с прицепами превышает указанное значение.
            </td>
        </tr>
        <tr>
            <td>27.1</td>
        ...
        <tr>
            <td>28</td>
            <td>Знак 250<img src="/img/signs/sign_250.jpg" /> Запрет для транспортных средств всех видов</td>
            <td>
                <span className="subtitle">Требование или запрет</span>
                <dl>
                    <dt>1.</dt>
        ...
        <tr>
            <td>29</td>
            <td>Знак 251<img src="/img/signs/sign_251.jpg" />Запрет движения механических транспортных средств</td>
            <td>
        ...
        <tr>
            <td>30</td>
            <td>Знак 253<img src="/img/signs/sign_253.jpg" /> Запрет движения механических транспортных средств свыше 3,5 т</td>
            <td>
                <span className="subtitle">Требование или запрет</span><br /> Запрещено движение транспортных средств с разрешенной максимальной массой больше 3,5 т, включая прицепы, а также для тягачей. Исключение составляют легковые автомобили и автобусы.<br />
        ...
        <tr>
            <td>30.1</td>
            <td><img src="/img/signs/sign_30.1.jpg" /><img src="/img/signs/sign_27.jpg" /></td>
            <td>
        ...
        <tr>
            <td>31</td>
            <td>Знак 254<img src="/img/signs/sign_254.jpg" /> Запрет велосипедного движения</td>
            <td>
        ...
        <tr>
            <td>32</td>
            <td>Знак 255<img src="/img/signs/sign_255.jpg" /> Запрет движения мотоциклов</td>
            <td>
        ...
        <tr>
            <td>33</td>
            <td>Знак 259<img src="/img/signs/sign_259.jpg" /> Запрет для пешеходов</td>
            <td>
        ...
        <tr>
            <td>34</td>
            <td>Знак 260<img src="/img/signs/sign_260.jpg" /> Запрет для транспортных средств</td>
            <td>
        ...
        <tr>
            <td>35</td>
            <td>Знак 261<img src="/img/signs/sign_261.jpg" /> Запрет для маркированных<br /> транспортных средств с опасными грузами</td>
            <td>
        ...
        <tr>
            <td>36</td>
            <td>Знак 262<img src="/img/signs/sign_262.jpg" /> Фактическая масса</td>
            <td>
        ...
        <tr>
            <td>37</td>
            <td>Знак 263<img src="/img/signs/sign_263.jpg" /> Фактическая осевая нагрузка</td>
            <td>
                <span className="subtitle">Пояснение</span><br /> Знак может быть интегрирован в табло со схемой перенаправления движения [<TrafficSign sign="501" title="пример" />], табло со схемой смещения движения [<TrafficSign sign="515" title="пример" />] или табло со схемой полос движения [<TrafficSign sign="fahrstreifentafel" title="пример" />]. В этом случае запрет касается только соответствующей полосы, для которой он установлен.
            </td>
        </tr>
        <tr>
            <td>38</td>
            <td>Знак 264<img src="/img/signs/sign_264.jpg" /> Фактическая ширина</td>
            <td>
        ...
        <tr>
            <td>39</td>
            <td>Знак 265<img src="/img/signs/sign_265.jpg" /> Фактическая высота</td>
            <td>
                <span className="subtitle">Пояснение</span><br /> Знак может быть интегрирован в табло со схемой перенаправления движения [<TrafficSign sign="501" title="пример" />], табло со схемой смещения движения [<TrafficSign sign="515" title="пример" />] или табло со схемой полос движения [<TrafficSign sign="fahrstreifentafel" title="пример" />]. В этом случае запрет касается только соответствующей полосы, для которой он установлен.
            </td>
        </tr>
        <tr>
            <td>40</td>
            <td>Знак 266<img src="/img/signs/sign_266.jpg" /> Фактическая длина</td>
            <td>
        ...
        <tr>
            <td>41</td>
            <td>Знак 267<img src="/img/signs/sign_267.jpg" /> Запрет на въезд</td>
            <td>
        ...
        <tr>
            <td>42</td>
            <td>Знак 268<img src="/img/signs/sign_268.jpg" /> Обязательное использование цепей противоскольжения</td>
            <td>
        ...
        <tr>
            <td>43</td>
            <td>Знак 269<img src="/img/signs/sign_269.jpg" /> Запрет для транспортных средств с<br /> опасным грузом</td>
            <td>
        ...
        <tr>
            <td>44</td>
            <td>Знак 270.1<img src="/img/signs/sign_270.1.jpg" />Начало зоны<br />запрета автомобильного движения<br/>для снижения загрязнения воздуха в зоне</td>
            <td>
                <span className="subtitle">Требование или запрет</span>
                <dl>
                    <dt>1.</dt>
        ...
        <tr>
            <td>45</td>
            <td>Знак 270.2<img src="/img/signs/sign_270_2.jpg" /> Конец зоны<br />запрета автомобильного движения<br/>для снижения загрязнения воздуха в зоне</td>
            <td></td>
        </tr>
        <tr>
            <td>46</td>
            <td><img src="/img/signs/sign_additional_270_1.jpg" /><br /> Освобождение от<br /> ограничения дорожного движения<br /> по § 40 абзац 1 Федерального закона о<br /> контроле выбросов</td>
            <td>
        ...
        <tr>
            <td>47</td>
            <td>Знак 272<img src="/img/signs/sign_272.jpg" /> Запрет разворота</td>
            <td>
        ...
        <tr>
            <td>48</td>
            <td>Знак 273<img src="/img/signs/sign_273.jpg" /> Запрет на<br /> сокращение<br /> указанного минимального расстояния</td>
            <td>
...
<table className="signs-table">
    ...
    <tbody>
        <tr>
            <td>49</td>
            <td>Знак 274<img src="/img/signs/sign_274.jpg" /> Допустимая<br /> максимальная скорость</td>
            <td>
                <span className="subtitle">Требование или запрет</span>
                <dl>
                    <dt>1.</dt>
        ...
        <tr>
            <td>50</td>
            <td>Знак 274.1<img src="/img/signs/sign_274.1.jpg" /> Начало зоны<br /> ограничения скорости 30 ки/ч</td>
            <td>
        ...
        <tr>
            <td>51</td>
            <td>Знак 274.2<img src="/img/signs/sign_274.2.jpg" /> Конец зоны ограничения<br /> скорости 30 км/ч</td>
            <td></td>
        </tr>
        <tr>
            <td>52</td>
            <td>Знак 275<img src="/img/signs/sign_275.jpg" /> Предписанная<br /> минимальная скорость</td>
            <td>
        ...
        <tr>
            <td>53</td>
            <td>Знак 276<img src="/img/signs/sign_276.jpg" /> Запрет обгона для<br /> всех видов транспортных средств</td>
            <td></td>
        </tr>
        <tr>
            <td>54</td>
            <td>Знак 277<img src="/img/signs/sign_277.jpg" /> Запрет обгона для<br /> транспортных средств свыше 3,5 т</td>
            <td>
        ...
        <tr>
            <td>54.4</td>
            <td>Знак 277.1<img src="/img/signs/sign_277.1.jpg" /> Запрет обгона<br /> одноколейных транспортных средств<br /> для многоколейных транспортных средств<br /> и мотоциклов с коляской</td>
            <td>
        ...
        <tr>
            <td>56</td>
            <td>Знак 278<img src="/img/signs/sign_278.jpg" /> Конец разрешенной<br /> максимальной скорости</td>
            <td>
        ...
        <tr>
            <td>57</td>
            <td>Знак 279<img src="/img/signs/sign_279.jpg" /> Конец предписанной<br /> минимальной скорости</td>
            <td>
        ...
        <tr>
            <td>58</td>
            <td>Знак 280<img src="/img/signs/sign_280.jpg" /> Конец запрета на обгон<br /> для всех видов транспортных средств</td>
            <td></td>
        </tr>
        <tr>
            <td>59</td>
            <td>Знак 281<img src="/img/signs/sign_281.jpg" /> Конец запрета на обгон<br /> для транспортных средств свыше 3,5 т</td>
            <td></td>
        </tr>
        <tr>
            <td>59.1</td>
            <td>Знак 281.1<img src="/img/signs/sign_281_1.jpg" /> Конец запрета на обгон<br /> одноколейных транспортных средств<br /> для многоколейных транспортных средств<br /> и мотоциклов с коляской</td>
            <td></td>
        </tr>
        <tr>
            <td>60</td>
            <td>Знак 282<img src="/img/signs/sign_282.jpg" /> Конец всех<br /> ограничений скорости<br /> и запретов на обгон</td>
            <td>
...
<table className="signs-table">
    ...
    <tbody>
        ...
        <tr>
            <td>62</td>
            <td>Знак 283<img src="/img/signs/sign_283.jpg" /> Абсолютный запрет на остановку</td>
            <td>
        ...
        <tr>
            <td>63</td>
            <td>Знак 286<img src="/img/signs/sign_286.jpg" /> Ограниченный запрет на остановку</td>
            <td>
                <span className="subtitle">Требование или запрет</span>
                <dl>
                    <dt>1.</dt>
        ...
        <tr>
            <td>64</td>
            <td>Знак 290.1<img src="/img/signs/sign_290.1.jpg" /> Начало<br /> ограниченного запрета на остановку<br /> для зоны</td>
            <td>
                <span className="subtitle">Требование или запрет</span>
                <dl>
                    <dt>1.</dt>
        ...
        <tr>
            <td>65</td>
            <td>Знак 290.2<img src="/img/signs/sign_290.2.jpg" /> Конец<br /> ограниченного запрета на остановку<br /> для зоны</td>
            <td></td>
        </tr>
    </tbody>
</table>
...
<table className="signs-table">
    ...
    <tbody>
        <tr>
            <td>66</td>
            <td>Знак 293<img src="/img/signs/sign_293.jpg" /> Пешеходный переход</td>
            <td>
        ...
        <tr>
            <td>67</td>
            <td>Знак 294<img src="/img/signs/sign_294.jpg" /> Линия остановки</td>
            <td>
        ...
        <tr>
            <td>68</td>
            <td>Знак 295<img src="/img/signs/sign_295.jpg" /> Граница полос движения,<br /> граница проезжей части и граница специальных путей</td>
            <td>
                <span className="subtitle">Требование или запрет</span>
                <dl>
                    <dt>1.</dt>
        ...
        <tr>
            <td>69</td>
            <td>Знак 296<img src="/img/signs/sign_296.jpg" /> Полоса B&nbsp;Полоса A<br /> Односторонняя<br /> разметка полос</td>
            <td>
                <span className="subtitle">Требование или запрет</span>
                <dl>
                    <dt>1.</dt>
        ...
        <tr>
            <td id="70">70</td>
            <td>Знак 297<img src="/img/signs/sign_297.jpg" /> Стрелочные разметки</td>
            <td>
                <span className="subtitle">Требование или запрет</span>
                <dl>
                    <dt>1.</dt>
        ...
        <tr>
            <td>71</td>
            <td>Знак 297.1<img src="/img/signs/sign_297.1.jpg" /> Предупреждающая стрелка</td>
            <td>
        ...
        <tr>
            <td>72</td>
            <td>Знак 298<img src="/img/signs/sign_298.jpg" /> Запрещенная зона</td>
            <td>
        ...
        <tr>
            <td>73</td>
            <td>Знак 299<img src="/img/signs/sign_299.jpg" /> Граничная разметка для<br /> запретов на остановку<br /> или стоянку</td>
            <td>
