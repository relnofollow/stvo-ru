    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                "уступи дорогу справа" (предложение 1 из [§ 8 (1)](/docs/general-traffic-rules/right-of-way#1)). Это также касается выезжающих велосипедистов. Если односторонняя улица с разрешенным движением велосипедов в противоположном направлении выходит на главную дорогу, то для велосипедистов, выезжающих из этой односторонней улицы, устанавливается знак <TrafficSign sign="205" />.
            </td>
        </tr>
    </tbody>
</table>
        ...
        <tr>
            ...
            <td>
                ...
                <dl>
                    ...
                    <dt>2.</dt>
                    <dd>
                        <div>Другие виды транспорта не должны ее использовать.</div>
                    </dd>
                    <dt>3.</dt>
                    <dd>
